...
function draw() {
    ...
    if(gameState.attempts > 19 && gameState.numMatched != gameState.totalPairs) {
        ...
        noStroke();
        textSize(64);
        text('YOU LOSE...', 960, 960);
        sounds[5].play(); 
        gameState.attempts = gameState.attempts - gameState.attempts;
        gameState.attempts = 0;
        gameState.numMatched = gameState.numMatched - gameState.numMatched;
